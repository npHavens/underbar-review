(function() {
  ...
  _.indexOf = (array, target) => {
    ...
    _.each(array, (item, index) => result = item === target && result === -1 ? index : result);
  ...
  _.reject = (collection, test) => _.filter(collection, element => !test(element));
  ...
  _.map = (collection, iterator) => {
    ...
    var mapped = [];
    _.each(collection, (element, i) => mapped.push(iterator(element, i)));
    return mapped;
  };
  ...
  _.reduce = (collection, iterator, accumulator) => {
    ...
    //   if(iterator(accumulator,element) === undefined){
    //     return accumulator;
    //   }
  ...
  _.every = (collection, iterator) => {
    if (iterator) {
      return _.reduce(collection, (isTrue, item) => !iterator(item) ? false : isTrue, true);
    }
    return _.reduce(collection, (isTrue, item) => item);
  };
  ...
  _.some = (collection, iterator) => {
    ...
    return !_.every(collection, item => !item);
  };
  ...
  _.extend = (obj, ...args) => {
    return _.reduce(args, (orig, newObj) => {
